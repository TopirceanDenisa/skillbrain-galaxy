...
// metoda ce va primi un parametru numit pozitiaInCampionat (un numar). Metoda va afisa “Am castigat locul ” urmat de valoarea
//  parametrului pozitiaInCampionat. Metoda va verifica daca pozitiaInCampionat este un numar mai mare ca 0,
...
class MasinaDeCurse extends Masina {
  ...
  rezultatCampionat(pozitia) {
    if (pozitia > 0) {
      console.log(`Am castigat locul ${pozitia}`);
    } else {
...
function main() {
  ...
  console.log(masina2.detalii);
  masina2.rezultatCampionat(0);
}
